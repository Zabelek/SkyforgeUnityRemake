...
public class SettingsManager : MonoBehaviour
{
    ...
    {
        SkyforgeLoader.SettingsSet.HighTextures = quality;
        if (quality)
        {
    ...
    {
        SkyforgeLoader.SettingsSet.HighShadows = quality;
        if (quality)
        {
    ...
    {
        SkyforgeLoader.SettingsSet.AntiAliasing = value;
    ...
    {
        SkyforgeLoader.SettingsSet.AdaptiveProbeVolume = value;
    ...
    {
        SkyforgeLoader.SettingsSet.SSR = value;
    ...
    {
        SkyforgeLoader.SettingsSet.Gamma = value;
    ...
    {
        SkyforgeLoader.SettingsSet.SFXVolume = value;
        if (_audioMixer != null)
        {
    ...
    {
        SkyforgeLoader.SettingsSet.VoiceVolume = value;
        if (_audioMixer != null)
        {
    ...
    {
        SkyforgeLoader.SettingsSet.MusicVolume = value;
        if (_audioMixer != null)
        {
    ...
    internal void SetSSAO(bool value)
    {
        SkyforgeLoader.SettingsSet.SSAO = value;
